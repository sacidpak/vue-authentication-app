        ...
        <div class="row  mt-5">
            <div class="col-md-4 offset-4 card card-primary p-3 border"
                ...
                <h3 :class="{'text-primary' : isUser, 'text-success' : !isUser }" 
                     class="text-center mb-3 mt-3">Vue.js | Auth
                </h3>
                <hr>
                <form @submit.prevent="onSubmit">
                    ...
                    <div class="form-group">
                        ...
                        <input v-model="user.password" type="password" class="form-control" placeholder="Please enter your password">
                    </div>
